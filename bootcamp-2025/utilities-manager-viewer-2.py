...
def load_file():   
    ...
    try:
        ...
        print(f"Error: The file '{st.session_state.current_file}' was not found!")
    except pd.errors.EmptyDataError:
        print(f"Error: The file '{st.session_state.current_file}' is empty!")
    except pd.errors.ParserError:
        print(f"Error: The file '{st.session_state.current_file}' could not be parsed!")
...
# UI for upload selection
# Upload file
st.session_state.current_file = st.file_uploader("Choose a file", type=["csv"])
